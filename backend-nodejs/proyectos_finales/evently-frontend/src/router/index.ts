...
const routes: RouteRecordRaw[] = [
  { path: '/', name: 'home', component: () => import('../views/HomeEvents.vue') },
  ...
  { path: '/me/subscriptions', name: 'my-subs', component: () => import('../views/MySubscriptions.vue'),
  ...
  { path: '/events/:id/edit', name: 'event-edit', component: () => import('../views/EventEdit.vue'), props: true,
    meta: { requiresAuth: true, roles: ['organizer','admin'] } },
