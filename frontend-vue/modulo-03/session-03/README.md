...
**Ejemplos populares:** Element Plus, Vuetify, PrimeVue, Quasar, Tailwind.
...
<template>
    <ui-dialog :visible="true" @close="$emit('close')">
        <form @submit.prevent="save">
            ...
            <ui-button type="primary" :loading="loading">{{
...
<template>
    <ui-dialog :visible="true" @close="$emit('cancel')">
        ...
        <ui-button type="danger" @click="$emit('confirm')"
            >Sí, eliminar</ui-button
        >
